...
{
    public partial class ViewPOYPackingForm : Form
    {
        ...
        public ViewPOYPackingForm()
        {
            Log.writeMessage("POY ViewPOYPackingForm - Start : " + DateTime.Now);

            InitializeComponent();
            ApplyFonts();
            //this.Shown += ViewPOYPackingForm_Shown;
            ...
            Log.writeMessage("POY ViewPOYPackingForm - End : " + DateTime.Now);
        }

        private void ViewPOYPackingForm_Load(object sender, EventArgs e)
        {
            Log.writeMessage("POY ViewPOYPackingForm_Load - Start : " + DateTime.Now);
        ...
        private void SrBoxNoList_TextUpdate(object sender, EventArgs e)
        {
            ...
            if (typedText.Length >= 2)
            {
                ...
                var srboxnoList = _packingService.getAllBoxNoByPackingType("POYPacking", typedText).Result;
        ...
        {
            Log.writeMessage("POY dataGridView1_RowPostPaint - Start : " + DateTime.Now);

            dataGridView1.Rows[e.RowIndex].Cells["SrNo"].Value = e.RowIndex + 1;

            Log.writeMessage("POY dataGridView1_RowPostPaint - End : " + DateTime.Now);
        }
