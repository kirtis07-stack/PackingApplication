...
namespace PackingApplication
{
    public partial class ChipsPackingList : Form
    {
        ...
        {
            var dtypackingList = await Task.Run(() => getAllChipsPackingList());
        ...
        private void addNew_Click(object sender, EventArgs e)
        {
            ...
            if (dashboard != null)
            {
                dashboard.LoadFormInContent(new ChipsPackingForm(0)); // open Add form
            }
        }
        ...
        private void listView1_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            if (info.Item != null && info.SubItem != null)
            {
                ...
                if (colIndex == listView1.Columns.Count - 1) // Action column (Edit)
                {
                    ...
                    if (dashboard != null)
                    {
                        dashboard.LoadFormInContent(new ChipsPackingForm(productionId)); // open Add form
                    }
                }
            }
        }
