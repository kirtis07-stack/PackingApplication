...
namespace PackingApplication
{
    public partial class AddDTYPackingForm : Form
    {
        ...
        string DTYPacking = ConfigurationManager.AppSettings["DTYPacking"];
        ...
        public AddDTYPackingForm()
        {
            ...
            Log.writeMessage("DTY AddDTYPackingForm constructor - End : " + DateTime.Now);
        }

        private void AddDTYPackingForm_Load(object sender, EventArgs e)
        {
            Log.writeMessage("DTY AddDTYPackingForm_Load - Start : " + DateTime.Now);
        ...
        //    try
        //    {
        //        Log.writeMessage("DTY AddDTYPackingForm_Shown - Start : " + DateTime.Now);
        ...
        //    }
        //    Log.writeMessage("DTY AddDTYPackingForm_Shown - End : " + DateTime.Now);
        //}
        ...
        private void LinoNoList_TextUpdate(object sender, EventArgs e)
        {
            ...
            if (typedText.Length >= 2)
            {
                ...
                {
                    machineList = _masterService.GetMachineList(DTYLot, typedText).Result.OrderBy(x => x.MachineName).ToList();

                    machineList.Insert(0, new MachineResponse { MachineId = 0, MachineName = "Select Line No." });
                }
                else
                {
                    machineList = _masterService.GetMachineByDepartmentIdAndLotType(selectedDeptId, DTYLot).Result.OrderBy(x => x.MachineName).ToList();
        ...
        private void MergeNoList_TextUpdate(object sender, EventArgs e)
        {
            ...
            if (typedText.Length >= 2)
            {
                ...
                {
                    mergenoList = _productionService.getLotsByLotType(DTYLot, typedText).Result.OrderBy(x => x.LotNoFrmt).ToList();
        ...
        {
            Log.writeMessage("DTY PrefixList_SelectionChangeCommitted - Start : " + DateTime.Now);
            ...
            if (PrefixList.SelectedValue != null)
            {
                ...
                //if (selectedSubDeptId != 0)
                //{
                //    machineList = _masterService.GetMachineByDepartmentIdAndLotType(selectedDeptId, DTYLot).Result;
            ...
            Log.writeMessage("DTY PrefixList_SelectionChangeCommitted - End : " + DateTime.Now);
        }
        ...
        public ProductionResponse SubmitPacking(ProductionRequest productionRequest, bool isPrint)
        {
            ...
            if (result != null && result.ProductionId > 0)
            {
                ...
                Log.writeMessage("DTY Print - End : " + DateTime.Now);
            }
            else
            {
                submit.Enabled = true;
        ...
        private void MergeNoList_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.F2) // Detect F2 key
            {
                ...
                selectedSubDeptId = 0;
                MergeNoList.DataSource = null;
                var mergenoList = _productionService.getLotsByLotType(DTYLot, "").Result.OrderBy(x => x.LotNoFrmt).ToList();
                mergenoList.Insert(0, new LotsResponse { LotId = 0, LotNoFrmt = "Select MergeNo" });
                MergeNoList.DisplayMember = "LotNoFrmt";
                MergeNoList.ValueMember = "LotId";
                MergeNoList.DataSource = mergenoList;
        ...
        {
            Log.writeMessage("DTY PrefixList_KeyDown - Start : " + DateTime.Now);
