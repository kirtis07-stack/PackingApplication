...
namespace PackingApplication
{
    public partial class AddDTYPackingForm : Form
    {
        ...
        private void AddDTYPackingForm_Load(object sender, EventArgs e)
        {
            ...
            Log.writeMessage("AddDTYPackingForm_Load - End : " + DateTime.Now);
        }
        ...
        private async void AddDTYPackingForm_Shown(object sender, EventArgs e)
        {
            try
            {
                Log.writeMessage("AddDTYPackingForm_Shown - Start : " + DateTime.Now);
            ...
            Log.writeMessage("AddDTYPackingForm_Shown - End : " + DateTime.Now);
        }
