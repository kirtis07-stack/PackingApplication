...
{
    public partial class AddBCFPackingForm : Form
    {
        ...
        public AddBCFPackingForm()
        {
            ...
            Log.writeMessage("BCF AddBCFPackingForm - End : " + DateTime.Now);
        }

        private void AddBCFPackingForm_Load(object sender, EventArgs e)
        {
            Log.writeMessage("BCF AddBCFPackingForm_Load - Start : " + DateTime.Now);
        ...
        {
            Log.writeMessage("BCF PrefixList_SelectionChangeCommitted - Start : " + DateTime.Now);
            ...
            if (PrefixList.SelectedValue != null)
            {
                ...
                var deptTask = _masterService.GetDepartmentList("BCF",selectedPrefix.Department).Result;
                deptTask.Insert(0, new DepartmentResponse { DepartmentId = 0, DepartmentName = "Select Dept" });
                DeptList.SelectedIndexChanged -= DeptList_SelectedIndexChanged;
                DeptList.DataSource = deptTask;
            ...
            Log.writeMessage("BCF PrefixList_SelectionChangeCommitted - End : " + DateTime.Now);
        }
        ...
        {
            Log.writeMessage("BCF PrefixList_KeyDown - Start : " + DateTime.Now);
            ...
            Log.writeMessage("BCF PrefixList_KeyDown - End : " + DateTime.Now);
        }
