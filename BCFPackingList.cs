...
{
    public partial class BCFPackingList : Form
    {
        ...
        public BCFPackingList()
        {
            InitializeComponent();
            ApplyFonts();
            this.Shown += BCFPackingList_Shown;
        ...
        private void BCFPackingList_Load(object sender, EventArgs e)
        {
        }
        ...
        private async void BCFPackingList_Shown(object sender, EventArgs e)
        {
            ...
            // Bind your list
            dataGridView1.DataSource = bcfpackingList;
